...
function removeItem(arr, deletedItem) {
  var updatedItems = arr.slice();
  for (var i = 0; i < arr.length; i++)  {
    if (arr[i] === deletedItem) {
...
function addItem(arr, addedItem)  {
  var newList = arr.slice()
...
function addTen(arr)  {
  var newNumberSet = []
  for (var i = 0; i < arr.length; i++)  {
    newNumberSet.push(arr[i]/1 + 10) // <--- Dividing by 1 turns the 'strings' into numbers
  }
  return newNumberSet
}
...
var user2 = {
    name: 'Kay Bailey',
    email: 'kaybailey@gmail.com',
    password: 'partyallDay',
    username: 'bettyboop'
}

var user3 = {
    name: 'Norman Pane',
    email: 'normanpane@gmail.com',
    password: 'geterdone',
